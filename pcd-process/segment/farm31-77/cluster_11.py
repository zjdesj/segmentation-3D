...
pcd_path = Path('/Users/wyw/Documents/Chaper2/github-code/data/cattle/31-77/uncertain')
name = '31-77_cropx_cropz_cluster_11.pcd'

def proc():
  calf = Farm(name, rotate=False, data_path=pcd_path, mkdir=False)
  calf.show_summary()
  #labels = calf.cluster(min_points=3, min_cluster=3000, eps=0.03)
