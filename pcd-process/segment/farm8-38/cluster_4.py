...
pcd_path = Path('/Users/wyw/Documents/Chaper2/github-code/data/cattle/8-38/uncertain')
name = '8-38_cropx_cropz_cluster_4.pcd'

def proc():
  calf = Farm(name, rotate=False, data_path=pcd_path, mkdir=False)
  calf.show_summary()
  labels = calf.cluster(min_points=1, min_cluster=400, eps=0.05)
