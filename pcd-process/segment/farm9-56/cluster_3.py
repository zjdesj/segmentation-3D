...
pcd_path = Path('/Users/wyw/Documents/Chaper2/github-code/data/cattle/9-56/uncertain')
name = '9-56_cropx_cropz_cluster_3.pcd'
...
def proc():
  ...
  labels = calf.cluster(min_points=3, min_cluster=4000, eps=0.03)
