...
pcd_path = Path('/Users/wyw/Documents/Chaper2/github-code/data/cattle/9-57/uncertain')
name = '9-57_cropx_cropz_cluster_10.pcd'
...
def proc():
  ...
  labels = calf.cluster(min_points=1, min_cluster=4000, eps=0.05)
