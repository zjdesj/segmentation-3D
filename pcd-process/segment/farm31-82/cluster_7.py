...
pcd_path = Path('/Users/wyw/Documents/Chaper2/github-code/data/cattle/31-82/uncertain')
name = '31-82_cropx_cropz_cluster_7.pcd'

def proc():
  calf = Farm(name, rotate=False, data_path=pcd_path, mkdir=False)
  calf.show_summary()
  labels = calf.cluster(min_points=2, min_cluster=3000, eps=0.02)
