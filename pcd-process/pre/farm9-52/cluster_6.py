...
pcd_path = Path('/Users/wyw/Documents/Chaper2/github-code/data/cattle/9-52/uncertain')
name = '9-52_cropx_cropz_cluster_6.pcd'

def proc():
  calf = Farm(name, rotate=False, data_path=pcd_path, mkdir=False)
  calf.show_summary()
  #labels = calf.cluster(min_points=25, min_cluster=1000, eps=0.03)
